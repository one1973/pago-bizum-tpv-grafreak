 ...
 * @subpackage Pago_Bizum_Grafreak/admin
...
/**
 * Pago_Bizum_Grafreak_Admin Class Doc Comment
 */
class Pago_Bizum_Grafreak_Admin {
	 ...
	 */
	private $option_name = 'pago_bizum_grafreak';
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/pago-bizum-grafreak-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/pago-bizum-grafreak-admin.js', array( 'jquery' ), $this->version, false );
	...
	public function add_options_page() {
		$this->plugin_screen_hook_suffix = add_options_page(
			__( 'TPV Configuration', 'pago-bizum-grafreak' ),
			__( 'TPV Configuration', 'pago-bizum-grafreak' ),
			'manage_options',
			$this->plugin_name,
	...
	public function display_options_page() {
		include_once 'partials/pago-bizum-grafreak-admin-display.php';
	}
	/**
	...
	public function register_setting() {
		add_settings_section(
			...
			__( 'General', 'pago-bizum-grafreak' ),
			array( $this, $this->option_name . '_general_cb' ),
			$this->plugin_name
		);
		add_settings_field(
			$this->option_name . '_habilitado',
			__( 'Enabled', 'pago-bizum-grafreak' ),
		...
		add_settings_field(
			...
			__( 'Url Test Environment', 'pago-bizum-grafreak' ),
		...
		add_settings_field(
			...
			__( 'URL Real Environment', 'pago-bizum-grafreak' ),
		...
		add_settings_field(
			...
			__( 'Active environment', 'pago-bizum-grafreak' ),
		...
		add_settings_field(
			...
			__( 'Trade name', 'pago-bizum-grafreak' ),
		...
		add_settings_field(
			...
			__( 'Merchant identifier (FUC)', 'pago-bizum-grafreak' ),
		...
		add_settings_field(
			...
			__( 'Language', 'pago-bizum-grafreak' ),
		...
		add_settings_field(
			...
			__( 'Terminal', 'pago-bizum-grafreak' ),
		...
		add_settings_field(
			...
			__( 'Encryption key', 'pago-bizum-grafreak' ),
		...
		add_settings_field(
			...
			__( 'Currency', 'pago-bizum-grafreak' ),
		...
		add_settings_field(
			...
			__( 'Global URL OK', 'pago-bizum-grafreak' ),
		...
		add_settings_field(
			...
			__( 'Global URL KO', 'pago-bizum-grafreak' ),
		...
		register_setting(
			...
			$this->option_name . '_urlok',
			array(
				'description'       => esc_html__( 'The URL that all the form with succesful payment will redirect. You can override this on every form', 'pago-bizum-grafreak' ),
		...
		register_setting(
			...
			$this->option_name . '_urlko',
			array(
				'description'       => esc_html__( 'The URL that all the form with error at payment will redirect. You can override this on every form', 'pago-bizum-grafreak' ),
				'sanitize_callback' => 'esc_url_raw',
			)
		);
	}
	 ...
	 * @since  1.0.0
	 */
	public function pago_bizum_grafreak_general_cb() {
		echo '<p>' . esc_html__( 'Change the data for those that have been provided to you.', 'pago-bizum-grafreak' ) . '</p>';
	}
	/**
	 ...
	 * @since  1.0.0
	 */
	public function pago_bizum_grafreak_habilitado_cb() {
		...
		?>
				<fieldset>
					...
					<?php esc_html_e( 'Enabled', 'pago-bizum-grafreak' ); ?>
					</label>
					...
					<?php esc_html_e( 'Disabled', 'pago-bizum-grafreak' ); ?>
					</label>
				</fieldset>
			<?php
	}
	 ...
	 * @since  1.0.0
	 */
	public function pago_bizum_grafreak_entornoact_cb() {
	 ...
	 * @since  1.0.0
	 */
	public function pago_bizum_grafreak_titulo_cb() {
	 ...
	 * @since  1.0.0
	 */
	public function pago_bizum_grafreak_urltest_cb() {
	 ...
	 * @since  1.0.0
	 */
	public function pago_bizum_grafreak_urlreal_cb() {
	 ...
	 * @since  1.0.0
	 */
	public function pago_bizum_grafreak_nombrecomercio_cb() {
	 ...
	 * @since  1.0.0
	 */
	public function pago_bizum_grafreak_idfuc_cb() {
	 ...
	 * @since  1.0.0
	 */
	public function pago_bizum_grafreak_terminal_cb() {
	 ...
	 * @since  1.0.0
	 */
	public function pago_bizum_grafreak_encriptkey_cb() {
	 ...
	 * @since  1.0.0
	 */
	public function pago_bizum_grafreak_moneda_cb() {
	 ...
	 * @since  1.0.0
	 */
	public function pago_bizum_grafreak_idioma_cb() {
	 ...
	 * @since  1.0.4
	 */
	public function pago_bizum_grafreak_urlok_cb() {
		...
		echo '<p>' . esc_html__( 'The URL that all the form with succesful payment will redirect. You can override this on every form', 'pago-bizum-grafreak' ) . '</p>';
	}
	/**
	 * Input para el nombre del comercio
	 *
	 * @since  1.0.4
	 */
	public function pago_bizum_grafreak_urlko_cb() {
		...
		echo '<p>' . esc_html__( 'The URL that all the form with error at payment will redirect. You can override this on every form', 'pago-bizum-grafreak' ) . '</p>';	}
	/**
	 ...
	 */
	public function pago_bizum_grafreak_sanitize_entornoact( $position ) {
	 ...
	 * @return string           Sanitized value
	 */
	public function pago_bizum_grafreak_sanitize_habilitado( $position ) {
