 ...
 * http://www.bizum.es/wps/portal/bizum/publica/areadeserviciosweb/descargaDeDocumentacionYEjecutables
 * Bizum Servicios de Procesamiento, S.L., CIF B85955367
 *
 * @link       http://www.grafreak.net
 * @since      1.0.0
 * @package    Pago_Bizum_Grafreak_BizumAPI_Grafreak
 ...
 * The bizum api class.
 *
 * This is used to comunicate and get from Bizum API
 *
...
class BizumAPI_Grafreak {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Pago_Bizum_Grafreak_vars_pay    $vars_pay    Array de datos de entrada.
	 */
	...
	public function create_merchant_signature_notif( $key, $datos ) {
		...
		// MAC256 del parámetro Ds_Parameters que envía Bizum.
